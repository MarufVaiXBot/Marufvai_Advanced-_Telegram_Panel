...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/wheels/bokeh-3.8.0-py3-none-any.whl', 'https://cdn.holoviz.org/panel/wheels/panel-1.8.2-py3-none-any.whl', 'pyodide-http'];
  if (path != null) {
